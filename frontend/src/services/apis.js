...
export const eventEndpoints = {
    ...
    GET_EVENTS_API: BASE_URL + "/event/getEvents",
    GET_EVENTS_API_ID: BASE_URL + "/event/getEvent",
    ADD_ATTENDEE_API: BASE_URL + "/event/addAttendee",
    ADD_NEW_TASK_API: BASE_URL + "/event/addTask",
    UPDATE_TASK_STATUS_API: BASE_URL + "/event/updateTaskStatus",
};
// PROFILE ENDPOINTS
export const profileEndpoints = {
    GET_USER_DETAILS_API: BASE_URL + "/profile/getUserDetails",
    GET_USER_ENROLLED_COURSES_API: BASE_URL + "/profile/getEnrolledCourses",
    GET_INSTRUCTOR_STATS_API: BASE_URL + "/profile/instructorDasboard"
};
